...
public class A03_VarTypes {
	...
	public static void main(String[] args) {
		...
		System.out.println("byte 타입에 저장할 수 있는 큰 값은" + maxByte + "이고, "
		...
		int manInt = 2_147_483_647;
		
		//숙제
		
		// int의 범위를 넘어가는 숫자를 사용할 떄는 L을 붙여야 한다 (그냥 숫자만 쓰는것은 int)
		...
		/*
		 	# boolean 타입
		 			...
		 			값은 true 와 false밖에 없다
		 */
		  boolean hasFodd = true;

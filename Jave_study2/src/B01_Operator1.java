...
public class B01_Operator1 {
	...
	public static void main(String[] args) {
		...
		/*
		 	Magh.round()는 소수 첫째 자리에서만 반올림 할 수 있다
		 	반올림하고 싶은 자리를 소수 첫쩨 자리로 만들만큼 곱한 후
		 	다시 나누는 방식을 통해 운하는 자릿수에서 반올림 할 수 있다
		 */
		System.out.println("소수 셋째 자리에서 반올림: " + Math.round(3.335 * 100) / 100);

	...
	public static void main(String[] args) {
		...
		/*
		 	# 서식 문자의 종류
		 		...
		 		%o 		: 해당 자리에 전달한 정수를8진수로 출력해준다 (octal)
		 		%s 		: 문자열 (string)
		 		%c 		: 문자 (character)
		 		%f 		: 실수 (float)
		...
		System.out.printf("사과 : %d게\n", 10);
		System.out.printf("사과 : %10d게\n", 10);			
		System.out.printf("사과 : %20d게\n", 10);			
